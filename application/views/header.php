...
<link rel="shortcut icon" type="image/x-icon" href=<? echo "".$base."/".$images."/favicon.ico"."";?>>
...
<a href=<?php echo "".$base."/index.php/home" ?>><img id="logo" src=<? echo "".$base."/".$images."/login/logo.jpg"."";?> ></a>
